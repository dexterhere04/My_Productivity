      ...
      components={{
        ...
        Dropdown: (props: DropdownProps) => {
            ...
            const handleValueChange = (value: string) => {
                if (props.name === 'months') {
                    props.onChange?.(new Date(props.value?.getFullYear() || 0, parseInt(value)));
                } else if (props.name === 'years') {
                    props.onChange?.(new Date(parseInt(value), props.value?.getMonth() || 0));
                }
            };
            ...
            return (
                ...
                >
                    <SelectTrigger>{props.value?.toLocaleString('default', { month: 'long' })}</SelectTrigger>
                    <SelectContent>
